...
public:
  ...
  void RotateFirstPerson_OX(float angle) {
    ...
    glm::vec4 aux =
        rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 0);
  ...
  void RotateFirstPerson_OY(float angle) {
    ...
    // vectors!
    glm::vec4 aux = rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) *
                    glm::vec4(forward, 0);
    forward = normalize(glm::vec3(aux));

    aux =
        rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
  ...
  void RotateFirstPerson_OZ(float angle) {
    ...
    glm::vec4 aux =
        rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
    right = normalize(glm::vec3(aux));

    aux = rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 0);
    forward = normalize(glm::vec3(aux));
  ...
  glm::vec3 GetWorldPosition() { return position; }
